    ...
    <div className="w-full min-h-screen flex bg-slate-200">
      ...
      <aside className="w-64 bg-white border-r border-slate-200 shadow-lg fixed h-full">
        ...
        <nav className="p-4 space-y-2">
          <a href="#" className="flex items-center px-4 py-2 text-slate-600 bg-slate-100 rounded-md">
            Home
          </a>
          <a href="#" className="flex items-center px-4 py-2 text-slate-600 hover:bg-slate-50 rounded-md">
